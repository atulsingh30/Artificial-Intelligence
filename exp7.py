...
def resolution():
    ...
    return answer  
#all buffalo are faster than all pigs
#all pigs are fater than all slug
#all buffalo are faster than pig and all pig faster than slug
#bob is buffalo
#pat is pig
#steve is slug
#(conclusion) pat is fater than steve
